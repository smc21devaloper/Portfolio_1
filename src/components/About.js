...
export default function About() {
    const config = {
        line1 : 'Hi, My name is Tamilarasi, I am a Computer Science Engineer. I am also passionate web developer built beautiful website with React.js and Tailwind CSS.',
